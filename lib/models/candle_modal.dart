...
class Candle_Sc extends StatefulWidget {
  const Candle_Sc({super.key});

  @override
  State<Candle_Sc> createState() => _Candle_ScState();
}

class _Candle_ScState extends State<Candle_Sc> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SfCartesianChart(
        ...
        title: ChartTitle(text: 'AXIS - 2023'),
        // legend: Legend(isVisible:Null),
